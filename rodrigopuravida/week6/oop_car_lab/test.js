...
myCar = new Car('Acura', 'Integra', 1999, 'Red', 4, ['Brian','Sarah']);
assert.deepEqual(myCar.passengers,['Brian','Sarah'],"Passengers array not updated. Expected ['Brian','Sarah']");
success();
...
assert.deepEqual(myCar.passengers,['Brian','Sarah','Sanda'],"Passengers array not updated. Expected ['Brian','Sarah','Sanda']");
success();
...
assert.deepEqual(myCar.passengers,['Brian','Sarah','Sanda'],"Passengers array updated despite all seats being filled. Expected ['Brian','Sarah','Sanda']");
success();
...
assert.deepEqual(myCar.passengers,['Brian','Sarah','Sanda'],"Passengers array updated despite being called with an invalid passenger. Expected ['Brian','Sarah','Sanda']");
myCar.off();
assert.strictEqual(myCar.dropOff('Brian'),false,'Car allowed dropping off a passenger when the car was off.');
assert.deepEqual(myCar.passengers,['Brian','Sarah','Sanda'],"Passengers array updated despite car being off. Expected ['Brian','Sarah','Sanda']");
myCar.start();
assert.strictEqual(myCar.dropOff('Brian'),true,'Car did NOT allow dropping off up a passenger when the car was running.');
assert.deepEqual(myCar.passengers,['Sarah','Sanda'],"Passengers array not updated. Expected ['Brian','Sarah','Sanda','Aaron']");
success();
